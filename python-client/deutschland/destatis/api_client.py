...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.chart2result  # this is an instance of the class Endpoint
        api_instance.chart2result()  # this invokes api_instance.chart2result.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.chart2result.callable or self.callable in this class
